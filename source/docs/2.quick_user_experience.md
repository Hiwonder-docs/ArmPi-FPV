...
安卓用户：可在本节目录下找到安装包，发送到手机后进行安装。需要注意，请务必在手机设置内为APP开启所有权限，否则可能会影响正常功能实现！

iOS用户：可前往App Store搜索"**WonderPi**"。

APP在使用前，手机请先开启GPS定位及Wi-Fi功能。

### 1.2 设备开机

1)  确认ArmPi FPV机械臂已按照"**[学前先看\2. 安装吸盘、货架及地图摆放]()**"正确放置在地图上。
...
豪华版与专业开发版用户可前往"**[智慧仓储课程\1. 货架的安装和摆放]()**"进行货架的组装，与玩法的体验。
...
1)  参照"**[上手试玩\1. 手机APP安装和连接]()**"内容，打开APP，连接设备。
