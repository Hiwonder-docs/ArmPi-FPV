...
Call and execute the action group programmed in the "[2. Action Group Programming](#anchor_2)" through the terminal command line.
...
Refer to the "[2. Action Group Programming](#anchor_2)" to study how to program and save action. We will take the example of the third action programmed and saved. 
