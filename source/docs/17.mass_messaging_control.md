# 10. Group Sending Control

## 10.1 Action Group Calling
...
### 10.1.2 Start and Close the Game
...
<img src="../_static/media/17.mass_messaging_control/2.1/image9.png" class="common_img" />

(5) Set the slave device's network mode to "2", which corresponds to LAN mode. "HW-123" and "hiwonder" are the Wi-Fi name and password of the host, which can be checked in section "[10.2.3 Operation steps->Check Host](#anchor_10_2_3_1)."
...
(5) Open a new terminal and type the command, then press **"Enter"** to control the robotic arm. Once successfully entered, it will display the IDs of the host and slave as shown in the figure below:
